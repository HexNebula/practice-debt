...
The whole product is one list. There are no charts: the spec is explicit that tracking and
visualisation are not the point, and exist only insofar as they make the queue trustworthy. What
